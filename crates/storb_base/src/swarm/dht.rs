...
use libp2p::{gossipsub, identify, identity, mdns, ping, Multiaddr, PeerId, SwarmBuilder};
...
pub struct StorbBehaviour {
    ...
    pub gossip: gossipsub::Behaviour<gossipsub::IdentityTransform>,
}
...
pub enum StorbEvent {
    ...
    Ping(Box<ping::Event>),
    /// Event from the Gossip protocol.
...
impl From<gossipsub::Event> for StorbEvent {
    fn from(event: gossipsub::Event) -> Self {
        StorbEvent::Gossip(Box::new(event))
    }
}
...
impl StorbDHT {
    ...
    pub fn new(
        ...
        let gossip = gossipsub::Behaviour::<gossipsub::IdentityTransform>::new(
